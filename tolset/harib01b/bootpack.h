...
#define MEMMAN_FREES		4090 // about take up 32KB, we use 32KB to record the information of free memory 

struct FREEINFO                  // used for marking the free memory segment
{
...
/* sheet.c */
struct SHEET {
	unsigned char *buf;   // save the pixel information
...
struct SHTCTL {
	unsigned char *vram, *map; // map is used for harib08h, aiming at eliminating flicker
	int xsize, ysize, top;
...
struct TASKCTL {
	...
	int now; // recording which task is running
